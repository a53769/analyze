...
localfn='D:\\workspace\\analyze\\iris.csv' #for windows
...
plot(data[target=='setosa',0],data[target=='setosa',2],'b.',label='setosa')
plot(data[target=='versicolor',0],data[target=='versicolor',2],'r.',label='versicolor')
plot(data[target=='virginica',0],data[target=='virginica',2],'g.',label='virginica')
...
plot(ssx,ssy,'b.',spx,spy,'b+')
plot(vsx,vsy,'r.',vpx,vpy,'r+')
plot(vgsx,vgsy,'g.',vgpx,vgpy,'g+')
show()
